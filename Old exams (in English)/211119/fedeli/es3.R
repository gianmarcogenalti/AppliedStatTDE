...
# still, it seems useful, let's see in the classifier what happens


cl1 <- qda(opera ~  precipitation, data = df, prior = priors)
pred <- predict(cl1)
...
# i am kinda confused, but, in effect, the variability was all
# in the other variable. We could skip temperature
