setwd("D:/RTDA/Didattica/Applied Statistics MATE 19-20/Lab11 - LM")
...
#    heignt at birth (t=0) is different between males and females?
# c) On the basis of model (a), is there statistical evidence that the mean 
#    heignt at adulthood (t=+inf) is different between males and females?
