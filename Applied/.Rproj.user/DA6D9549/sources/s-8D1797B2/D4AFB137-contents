...
setwd("D:/RTDA/Didattica/Applied Statistics MATE 19-20/Lab 6 - 17042020")
...
dev.off()
# Note: The simulaneous confidence intervals and the Bonferroni intervals
...
# The genetists suspect that some of these mutations might be positively associated
