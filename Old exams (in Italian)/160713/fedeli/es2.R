...
IC1 <- c(t1.mean[1]-t2.mean[1] - qt(1-alpha/(2*k), n-1) * sqrt(Sp[1,1])/n ,t1.mean[1]-t2.mean[1] + qt(1-alpha/(2*k), n-1) * sqrt(Sp[1,1])/n )
IC1
IC2 <- c(t1.mean[2]-t2.mean[2] - qt(1-alpha/(2*k), n-1) * sqrt(Sp[2,2])/n ,t1.mean[2]-t2.mean[2] + qt(1-alpha/(2*k), n-1) * sqrt(Sp[2,2])/n )
IC2
IC3 <- c(t1.mean[3]-t2.mean[3] - qt(1-alpha/(2*k), n-1) * sqrt(Sp[3,3])/n ,t1.mean[3]-t2.mean[3] + qt(1-alpha/(2*k), n-1) * sqrt(Sp[3,3])/n )
IC3
