...
# distance:time.of.the.day 26827.942691  2       12.798140   sembra che time of the day generi collinearità
...
linearHypothesis(mod1, rbind(c(0,0,1,0,0,0),
                             c(0,0,0,1,0,0)), c(0,0)) # pvalue = 0.466 il giorno della settimana in sé non sembra influenzare

# dal summary(mod1) e dalle collinearità capisco comunque che il modello va ridotto

mod2 <- lm(duration ~ distance + distance:time.of.the.day, data = df)
summary(mod2) # piccolo miglioramento nell'R^2 e nella significatività delle variabili
...
# essendo l'upper bound di 115 minuti circa, per essere lì al 99% alle 9:30 dovrò partire al più con lo shuttle
# delle 7:30
